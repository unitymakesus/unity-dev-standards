...
@section('content')
  ...
  <p>The goal of this document is to provide our developers and collaborators a set of unified approaches, best practices, and recommendations to use when building custom WordPress websites or other coding projects.</p>

  <h2>Who Is Resource This For?</h2>
